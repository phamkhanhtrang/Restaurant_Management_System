...
import com.example.rms.menu_module.repository.CategoryRepository;
import com.example.rms.menu_module.repository.ProductRepository;
...
public class MenuServiceImpl implements MenuService{
    ...
    public MenuCategoryDTO createCategory(MenuCategoryDTO dto) {
        ...
        MenuCategory saved = categoryRepository.save(category); // cascade sẽ lưu cả profile nếu ánh xạ đúng
        return toDTO(saved); // trả về DTO có cả profile nếu cần
    }
...
//    }
    ...
    public MenuProductDTO createProduct(String categoryID, MenuProductDTO dto) {
        ...
        product.setIs_deleted(dto.isDeleted()); // nếu DTO có getter isDeleted()
        // Lưu sản phẩm
